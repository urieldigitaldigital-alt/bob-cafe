...
const ARROW_CLASSES =
  "relative flex items-center justify-center rounded-full border-[1.5px] border-line bg-background/60 backdrop-blur-[16px] text-foreground/50 cursor-pointer shrink-0 z-30 outline-none shadow-[0_4px_20px_rgba(0,0,0,0.1)] hover:border-primary/50 hover:text-foreground active:opacity-70 transition-colors duration-300 before:content-[''] before:absolute before:inset-[3px] before:rounded-full before:border before:border-foreground/[0.04] before:pointer-events-none";
            ...
            {cards.map((_, i) => (
              <span
                ...
                className={`h-2 w-2 rounded-full transition-all duration-300 ${
                  i === centerIndex ? "scale-[1.3] bg-primary" : "bg-foreground/15"
                }`}
              />
            ))}
          </div>
